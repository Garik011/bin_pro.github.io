	$(document).ready(function() {
		...
		var pagesList = {
			'Главная' : 'index.html',
			'Светлая тема' : 'light-theme.html',
			'Пользователь авторизован' : 'user-auth.html'
		};
		...
		if($(window).width() > 750) { 
				...
				var link=$(`
					<div class="pages">
						...
						<div class="pages-swticher-header">
							<div class="pages-switcher-heading">Ссылки на превью страниц</div>
						</div>
						...
						body {
						   ...
						   height: auto;
							...
							.pages-switcher-heading {
								...
								/*-webkit-box-shadow: 0px 10px 13px 0px rgba(25,25,25,1);*/
								/*-moz-box-shadow: 0px 10px 13px 0px rgba(25,25,25,1);*/
								/*box-shadow: 0px 10px 13px 0px rgba(25,25,25,1);*/
							}
							.pages-swticher-list {
								padding-top: 20px;
							}
			...
			$(ul).addClass('pages-swticher-list').appendTo('.pages-swticher-body');
